...
const pluginList = function() {
    ...
    if(isBuildEnabled('windowsphone8') || isBuildEnabled('windowsphone81s')) {
        plugins['com.kony.windowsphone8'] = 'Windows_Phone8_Plugin';
    }

    if(isBuildEnabled('windowsphone10') || isBuildEnabled('windows10')) {
        plugins['com.kony.windows10'] = 'Windows10_Plugin';
    }

    if(isBuildEnabled('windows8.1')) {
        plugins['com.kony.windows8'] = 'Windows8_Plugin';
    }

    if(isBuildEnabled('desktop_kiosk')) {
        plugins['com.kony.windows'] = 'Windows_Desktop_Plugin';
    }
    return plugins;
}();
...
function prebuild(){
    ...
    if(missingPlugins.length){
        throw new BuildException("missing plugins: " + missingPlugins.join(', '));
    }
